...
export default function NovoRegisto() {
  ...
  return (
    <div className="p-6">
      <Breadcrumb />
      <h1 className="text-xl font-bold text-byd-dark mb-6">Novo Registo</h1>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        {step === 1 && (
          <div>
            <h2 className="text-base font-semibold text-byd-dark mb-4">Dados da Viatura</h2>
            ...
            {vehicle && (
              <div className="bg-gray-50 rounded-lg p-4 mb-4 border border-gray-200">
                <p className="text-xs font-semibold text-byd-dark uppercase tracking-wide mb-3">Viatura Encontrada</p>
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {[
                    ...
                    { label: 'Motorização', value: vehicle.motorizacao },
                  ].map(f => (
                    <div key={f.label}>
        ...
        {step === 2 && (
          <div>
            <h2 className="text-base font-semibold text-byd-dark mb-4">Dados do Concessionário</h2>
        ...
        {step === 3 && (
          <div>
            <h2 className="text-base font-semibold text-byd-dark mb-4">Dados do Serviço</h2>
